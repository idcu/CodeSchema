...
> 依据：实际 Go 包依赖关系（`internal/` 下 32 个 Go 包，`go list ./internal/...` 验证；含 `cmd`/`contrib`/`scripts` 全仓库共 36 个，`go list ./...`）+ 架构分层，非拍脑袋。
...
| ├ P3_3 SCIP | [P3_3.md](./P3_3.md) | 97% | ├ P8_3 指标 | [P8_3.md](./P8_3.md) | 100% |
