...
- **模块成熟度轴** git 历史（2026-09-02 重构前文档）：各 `P*.md` 标注 95–98%，表示持续打磨中，**非未交付**。
...
- 模块边界、分层与子项清单（cmd 8 子命令 + internal 26 顶层包职责）见 [01-开发者/架构与模块](../01-开发者/架构与模块.md)。
- 完整「根目录每个目录/文件的功能用途、是否进版本库、命名与位置建议」见 [仓库结构.md](../仓库结构.md)。
